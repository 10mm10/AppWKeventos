...
export const styles = StyleSheet.create({
  ...
  title: { color: WK_BRANCO, fontSize: 22, fontWeight: 'bold' },
  form: { padding: 20 },
  label: { fontSize: 16, fontWeight: '600', marginBottom: 8, color: '#374151' },
  
  // Inputs
  input: { 
    backgroundColor: WK_BRANCO, padding: 12, borderRadius: 8, 
    borderWidth: 1, borderColor: '#d1d5db', marginBottom: 20,
    fontSize: 16, color: WK_CHUMBO 
  },
  inputInsumos: { 
    height: 100, textAlignVertical: 'top' // Para o campo de texto grande
  },
  inputDestaque: { color: '#ef4444', fontWeight: 'bold' }, // Usado no Desconto

  // Botões
  button: { 
    backgroundColor: WK_VERMELHO, padding: 16, borderRadius: 8, 
    alignItems: 'center', marginTop: 10, elevation: 2 
  },
  buttonText: { color: WK_BRANCO, fontWeight: 'bold', fontSize: 16 },
  ...
  // Cards de Itens
  itemCard: {
    backgroundColor: WK_BRANCO, padding: 15, borderRadius: 8, 
    marginBottom: 10, borderLeftWidth: 5, borderLeftColor: WK_AMARELO, elevation: 2
  },
